...
while 1:
    data = sniffer_socket_object.recvfrom(65565)[0]
    print("")
    ...
    # Basically, this is a dictionary, and the values are little python commands
    # that print out the IP data from a packet.
    IPSTRUCTURE ={
